    ...
    $('.js-getResult').on('change', function(){
        ...
        setTimeout(function(){
            ...
            if(CheckSlide){
                ...
                switch (valCheck) {
                    case 0:
                        $('.resheader').html('Baja probabilidad de cistitis');
                        $('.restext').html('No te olvides de la prevención estacional.<br> с <span><b>Cystenon</b></span>');
                        break;
                    case 1:
                        $('.resheader').html('La probabilidad promedio de cistitis');
                        $('.restext').html('Curso de prevención recomendado <span><b>Cystenon</b></span>.');
                        break;
                    case 2:
                        $('.resheader').html('Alta probabilidad de cistitis');
                        $('.restext').html('Cursos regulares recomendados <span><b>Cystenon</b></span><br> 3-4 veces al año.');
                        break;
                    default:
                        $('.resheader').html('Alta probabilidad de cistitis');
                        $('.restext').html('Cursos regulares recomendados <span><b>Cystenon</b></span><br>  3-4 veces al año.');
